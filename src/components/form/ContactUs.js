...
export default function ContactUs() {
    ...
    function sendEmail(e) {
        ...
        emailjs.sendForm('service_80yt1eb', 'template_0ol1uhi', e.target, 'user_qxctVS89sIZIG1r6feof5')
            .then((result) => {
            ...
            <div className="container">
                <form onSubmit={sendEmail}>
                    <div className="row pt-5 mx-auto">
                        ...
                        <div className="col-8 form-group pt-2 mx-auto">
                            <input type="text" className="form-control" placeholder="Название техники" name="subject" />
                        </div>
                        <div className="col-8 form-group pt-2 mx-auto">
